 ...
 *
 */
public class LockON extends PIDCommand {
    ...
    protected double returnPIDInput() {
        ...
        return RobotMap.driveTrainpixyX.pidGet();
    ...
    protected void usePIDOutput(double output) {
        ...
        RobotMap.intakeintake.pidWrite(output);
    ...
    protected boolean isFinished() {
        return !RobotMap.driveTrainpixyON.get();
    }
